      ...
      <section className=" min-h-screen flex flex-col justify-center bg-[url('/asset/bg-profile.png')] bg-cover">
        {loading ? (
          ...
          <div className="flex flex-col items-center">
            <div className="text-center font-bold text-2xl mt-10">Profile</div>

            <div className="w-[300px] h-[720px] mx-auto flex flex-col md:w-[600px] ">
              <div
                data-id="0"
                className=" w-[300px] h-[290px] md:w-[600px] md:h-[450px] mt-5 relative inline-block px-4 py-2 font-medium group"
              >
                ...
                <span className="relative text-white">
                  <div className="text-sm md:text-lg mx-5 md:mx-20 mt-[30px] text-center">
                    <img
                      src={
                        user.pict != null ? user.pict : '/asset/logo-user.png'
                      }
                      className=" ml-[154px] mt-[-15px] mb-8 h-[100px] w-[100px] rounded-full"
                    />
              ...
              <button
                onClick={pdfGenerate}
                className="absolute inline-block px-2 py-1 ml-[93px] md:ml-[285px] mt-[255px] md:mt-[400px] group  "
              >
                <span className="absolute inset-0 w-full h-full transition duration-200 ease-out transform translate-x-1 translate-y-1 bg-black group-hover:-translate-x-0 group-hover:-translate-y-0"></span>
                <span className="absolute inset-0 w-full h-full bg-white border-2 border-black group-hover:bg-black"></span>
                <span className="relative text-black text-sm md:text-md group-hover:text-white">
