...
const Edit = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put("/user/profile/" + id, formData, {
        headers: { Authorization: tokenJwt.tokenJwt, "Content-Type": "multipart/form-data" },
      })
      .then((response) => {
        setSuccess(true);
      ...
      {success ? (
        ...
        <section>
          ...
          <div className="edit-page flex flex-col justify-center items-center min-h-screen text-[15px] bg-[url('/asset/bg-profile.png')] bg-cover ">
            ...
            <div data-id="0" className=" w-[300px] h-[450px] md:h-[600px] md:w-[500px]  mx-auto relative  px-4 py-2 flex flex-col items-center font-medium group">
              ...
              <span className="relative text-white text-lg ">
                <div className="">
                  <div className="edit-comp">
                    ...
                    <form action="POST" className="w-[260px] md:w-[350px] mt-[30px]" onSubmit={handleSubmit}>
                      ...
                      <button disabled={!validEmail || !validFullName ? true : false} className="px-5 py-2.5 relative rounded group font-medium text-white inline-block ml-[80px] md:ml-[125px] mt-[60px]" type="submit">
