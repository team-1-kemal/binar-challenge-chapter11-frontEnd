                ...
                <div className="">
                  <div className="edit-comp">
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        disabled={!validEmail || !validFullName === true}
                      ...
                      >
                        ...
                        <span className="absolute inset-0 w-full h-full transition duration-200 ease-out rounded bg-gradient-to-br to-slate-600 from-slate-500" />
