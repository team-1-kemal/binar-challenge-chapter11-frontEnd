...
const Register = () => {
  ...
  return (
    <>
      {success ? (
        <section className="bg-[url('/asset/bg-register.png')] bg-center my-auto min-h-screen flex flex-col bg-cover items-center">
          ...
          <div className='flex flex-col lg:min-h-[720px] lg:my-auto'>
            ...
            <form onSubmit={handlerSubmit} className=''>
              ...
              <div className='flex-col flex lg:flex-row lg:gap-10 justify-center items-center '>
                <div className='relative flex flex-col'>
                  ...
                  <label htmlFor='email' className='text-white'>
                    Email:
                    <span
                      className={validEmail ? 'text-green-400 ml-1' : 'hidden'}
                    >
                      <FontAwesomeIcon icon={faCheck} />
                    </span>
                    <span
              ...
              <div className='absolute lg:ml-[170px]'>
                <button
                  className='absolute inline-block  ml-[70px] mt-[50px] px-6 py-2 font-semibold group lg:px-6 lg:py-3 lg:mt-[70px] mb-7 cursor-pointer'
                  disabled={
